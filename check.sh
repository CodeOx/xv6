...
# make qemu 
echo "Running..1"
./test_assig1_long.sh assig1_1|grep -i 'sys_'|sed 's/$ //g'|sort > res_assig1_1

echo "Running..2"
./test_assig1_long.sh assig1_2|grep -i 'sys_'|sed 's/$ //g'|sort > res_assig1_2

echo "Running..3"
./test_assig1_long.sh assig1_3|grep -i Sum|sed 's/$ //g'|sort > res_assig1_3

echo "Running..4"
./test_assig1_long.sh assig1_4|grep -i Sum|sed 's/$ //g'|sort > res_assig1_4

echo "Running..5"
./test_assig1_long.sh assig1_5|grep -i pid|sed 's/$ //g'|sort > res_assig1_5

echo "Running..6"
./test_assig1_long.sh assig1_6|grep -i pid|sed 's/$ //g'|sort > res_assig1_6

echo "Running..7"
./test_assig1_long.sh assig1_7|grep -i 'PARENT\|CHILD'|sed 's/$ //g'|sort> res_assig1_7
